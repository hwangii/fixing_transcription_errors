...
local original "F:\enum_date\DATA\ORIGINAL\"
...
quietly infix                     ///
  ...
  byte    incnonwg       93-93    ///
  byte    migrate5       94-94    ///
  byte    migrate5d      95-96    ///
  int     migplac5       97-99    ///
  int     migcountyicp5  100-103  ///
  str     histid         104-139  ///
  byte    ssenroll       140-140  ///
  using `"`original'usa_00647.dat"'
...
label var migcountyicp5 `"County of residence 5 years ago (ICPSR code)"'
...
label define fbpld_lbl 00810 `"Colorado Territory"', add
...
label define fbpld_lbl 03010 `"Montana Territory"', add
label define fbpld_lbl 03100 `"Nebraska"', add
label define fbpld_lbl 03110 `"Nebraska Territory"', add
label define fbpld_lbl 03200 `"Nevada"', add
label define fbpld_lbl 03210 `"Nevada Territory"', add
...
label define fbpld_lbl 05310 `"Washington Territory"', add
...
label define fbpld_lbl 71015 `"Fiji"', add
...
label define higrade_lbl 99 `"Missing"', add
...
drop related higraded empstatd classwkrd migrate5d raced bpld fbpld mtongued migplac5 migcountyicp5

gen non_english_mtongue=1 if mtongue>=2 & mtongue<=94
replace non_english_mtongue=0 if mtongue==1

label define non_english_mtongue 1 "English is not mother tongue" 0 "English is mother tongue"
label values non_english_mtongue non_english_mtongue

save `"`original'all_states_socio_demo_char_for_SSHA2025.dta"',replace
