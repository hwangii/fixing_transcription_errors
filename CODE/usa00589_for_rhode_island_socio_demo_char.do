...
quietly infix                 ///
  ...
  byte    incnonwg   89-89    ///
  byte    migrate5   90-90    ///
  byte    migrate5d  91-92    ///
  int     migplac5   93-95    ///
  int     migcounty  96-99    ///
  str     histid     100-135  ///
  byte    ssenroll   136-136  ///
  using `"`original'usa_00589.dat"'
...
label define fbpld_lbl 71015 `"[no label]"', add
...
drop related higraded empstatd classwkrd migrate5d
...
save `"`original'rhode_island_socio_demo_char.dta"',replace
