...
label define vet1930_lbl 6 `"Period of service not ascertained"', add
label define vet1930_lbl 7 `"Veteran status missing but war field implies veteran status"', add
label define vet1930_lbl 8 `"Illegible"', add
